...
class UnitTestDB:
    ...
    def __init__(self, url: URL, dump_dir: os.PathLike, name: str = None) -> None:
        db_url = make_url(url)
    ...
    @staticmethod
    def _parse_sql_file(filepath: os.PathLike) -> Iterator[sqlalchemy.sql.expression.TextClause]:
